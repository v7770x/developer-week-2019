...
def classify_image(url):
    ...
    #     ]
    # }
    headers = {'Authorization':'Key 53785869e72f4901a7f93891241cdc10', 'Content-type':'application/json'}
...
def save_image_props_to_database():
    ...
    new_datum = {"user":user,"url": url, "location": {"latitude":latitude,"longitude":longitude},"classification":classification}
